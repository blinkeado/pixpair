 ...
 */if(mT()&&self.firebase!==void 0){Lm.warn(`
  ...
  `);const t=self.firebase.SDK_VERSION;t&&t.indexOf("LITE")>=0&&Lm.warn(`
    ...
    `)}const U=UC;zC();var WC="firebase",BC="9.23.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rf{constructor(){this.providerId="phone",this._delegate=new qr(bw(U.auth()))}static credential(e,n){return qr.credential(e,n)}verifyPhoneNumber(e,n){return this._delegate.verifyPhoneNumber(e,n)}unwrap(){return this._delegate}}Rf.PHONE_SIGN_IN_METHOD=qr.PHONE_SIGN_IN_METHOD;Rf.PROVIDER_ID=qr.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xP=E;class OP{constructor(e,n,r=U.app()){var i;xP((i=r.options)===null||i===void 0?void 0:i.apiKey,"invalid-api-key",{appName:r.name}),this._delegate=new HR(e,n,r.auth()),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rx{constructor(e){this._delegate=e}cancel(e){M("OnDisconnect.cancel",0,1,arguments.length),ke("OnDisconnect.cancel","onComplete",e,!0);const n=this._delegate.cancel();return e&&n.then(()=>e(null),r=>e(r)),n}remove(e){M("OnDisconnect.remove",0,1,arguments.length),ke("OnDisconnect.remove","onComplete",e,!0);const n=this._delegate.remove();return e&&n.then(()=>e(null),r=>e(r)),n}set(e,n){M("OnDisconnect.set",1,2,arguments.length),ke("OnDisconnect.set","onComplete",n,!0);const r=this._delegate.set(e);return n&&r.then(()=>n(null),i=>n(i)),r}setWithPriority(e,n,r){M("OnDisconnect.setWithPriority",2,3,arguments.length),ke("OnDisconnect.setWithPriority","onComplete",r,!0);const i=this._delegate.setWithPriority(e,n);return r&&i.then(()=>r(null),s=>r(s)),i}update(e,n){if(M("OnDisconnect.update",1,2,arguments.length),Array.isArray(e)){const i={};for(let s=0;s<e.length;++s)i[""+s]=e[s];e=i,XE("Passing an Array to firebase.database.onDisconnect().update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")}ke("OnDisconnect.update","onComplete",n,!0);const r=this._delegate.update(e);return n&&r.then(()=>n(null),i=>n(i)),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nx{constructor(e,n){this.committed=e,this.snapshot=n}toJSON(){return M("TransactionResult.toJSON",0,1,arguments.length),{committed:this.committed,snapshot:this.snapshot.toJSON()}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class er{constructor(e,n){this._database=e,this._delegate=n}val(){return M("DataSnapshot.val",0,0,arguments.length),this._delegate.val()}exportVal(){return M("DataSnapshot.exportVal",0,0,arguments.length),this._delegate.exportVal()}toJSON(){return M("DataSnapshot.toJSON",0,1,arguments.length),this._delegate.toJSON()}exists(){return M("DataSnapshot.exists",0,0,arguments.length),this._delegate.exists()}child(e){return M("DataSnapshot.child",0,1,arguments.length),e=String(e),bo("DataSnapshot.child","path",e,!1),new er(this._database,this._delegate.child(e))}hasChild(e){return M("DataSnapshot.hasChild",1,1,arguments.length),bo("DataSnapshot.hasChild","path",e,!1),this._delegate.hasChild(e)}getPriority(){return M("DataSnapshot.getPriority",0,0,arguments.length),this._delegate.priority}forEach(e){return M("DataSnapshot.forEach",1,1,arguments.length),ke("DataSnapshot.forEach","action",e,!1),this._delegate.forEach(n=>e(new er(this._database,n)))}hasChildren(){return M("DataSnapshot.hasChildren",0,0,arguments.length),this._delegate.hasChildren()}get key(){return this._delegate.key}numChildren(){return M("DataSnapshot.numChildren",0,0,arguments.length),this._delegate.size}getRef(){return M("DataSnapshot.ref",0,0,arguments.length),new br(this._database,this._delegate.ref)}get ref(){return this.getRef()}}class be{constructor(e,n){this.database=e,this._delegate=n}on(e,n,r,i){var s;M("Query.on",2,4,arguments.length),ke("Query.on","callback",n,!1);const o=be.getCancelAndContextArgs_("Query.on",r,i),a=(u,d)=>{n.call(o.context,new er(this.database,u),d)};a.userCallback=n,a.context=o.context;const l=(s=o.cancel)===null||s===void 0?void 0:s.bind(o.context);switch(e){case"value":return th(this._delegate,a,l),n;case"child_added":return Dg(this._delegate,a,l),n;case"child_removed":return Ug(this._delegate,a,l),n;case"child_changed":return Lg(this._delegate,a,l),n;case"child_moved":return Mg(this._delegate,a,l),n;default:throw new Error(st("Query.on","eventType")+'must be a valid event type = "value", "child_added", "child_removed", "child_changed", or "child_moved".')}}off(e,n,r){if(M("Query.off",0,3,arguments.length),kx("Query.off",e,!0),ke("Query.off","callback",n,!0),km("Query.off","context",r,!0),n){const i=()=>{};i.userCallback=n,i.context=r,Fg(this._delegate,e,i)}else Fg(this._delegate,e)}get(){return Ub(this._delegate).then(e=>new er(this.database,e))}once(e,n,r,i){M("Query.once",1,4,arguments.length),ke("Query.once","callback",n,!0);const s=be.getCancelAndContextArgs_("Query.once",r,i),o=new Ze,a=(u,d)=>{const c=new er(this.database,u);n&&n.call(s.context,c,d),o.resolve(c)};a.userCallback=n,a.context=s.context;const l=u=>{s.cancel&&s.cancel.call(s.context,u),o.reject(u)};switch(e){case"value":th(this._delegate,a,l,{onlyOnce:!0});break;case"child_added":Dg(this._delegate,a,l,{onlyOnce:!0});break;case"child_removed":Ug(this._delegate,a,l,{onlyOnce:!0});break;case"child_changed":Lg(this._delegate,a,l,{onlyOnce:!0});break;case"child_moved":Mg(this._delegate,a,l,{onlyOnce:!0});break;default:throw new Error(st("Query.once","eventType")+'must be a valid event type = "value", "child_added", "child_removed", "child_changed", or "child_moved".')}return o.promise}limitToFirst(e){return M("Query.limitToFirst",1,1,arguments.length),new be(this.database,Ot(this._delegate,$b(e)))}limitToLast(e){return M("Query.limitToLast",1,1,arguments.length),new be(this.database,Ot(this._delegate,qb(e)))}orderByChild(e){return M("Query.orderByChild",1,1,arguments.length),new be(this.database,Ot(this._delegate,Qb(e)))}orderByKey(){return M("Query.orderByKey",0,0,arguments.length),new be(this.database,Ot(this._delegate,Jb()))}orderByPriority(){return M("Query.orderByPriority",0,0,arguments.length),new be(this.database,Ot(this._delegate,Zb()))}orderByValue(){return M("Query.orderByValue",0,0,arguments.length),new be(this.database,Ot(this._delegate,tx()))}startAt(e=null,n){return M("Query.startAt",0,2,arguments.length),new be(this.database,Ot(this._delegate,Wb(e,n)))}startAfter(e=null,n){return M("Query.startAfter",0,2,arguments.length),new be(this.database,Ot(this._delegate,Vb(e,n)))}endAt(e=null,n){return M("Query.endAt",0,2,arguments.length),new be(this.database,Ot(this._delegate,Fb(e,n)))}endBefore(e=null,n){return M("Query.endBefore",0,2,arguments.length),new be(this.database,Ot(this._delegate,zb(e,n)))}equalTo(e,n){return M("Query.equalTo",1,2,arguments.length),new be(this.database,Ot(this._delegate,rx(e,n)))}toString(){return M("Query.toString",0,0,arguments.length),this._delegate.toString()}toJSON(){return M("Query.toJSON",0,1,arguments.length),this._delegate.toJSON()}isEqual(e){if(M("Query.isEqual",1,1,arguments.length),!(e instanceof be)){const n="Query.isEqual failed: First argument must be an instance of firebase.database.Query.";throw new Error(n)}return this._delegate.isEqual(e._delegate)}static getCancelAndContextArgs_(e,n,r){const i={cancel:void 0,context:void 0};if(n&&r)i.cancel=n,ke(e,"cancel",i.cancel,!0),i.context=r,km(e,"context",i.context,!0);else if(n)if(typeof n=="object"&&n!==null)i.context=n;else if(typeof n=="function")i.cancel=n;else throw new Error(st(e,"cancelOrContext")+" must either be a cancel callback or a context object.");return i}get ref(){return new br(this.database,new bt(this._delegate._repo,this._delegate._path))}}let br=class di extends be{constructor(e,n){super(e,new ot(n._repo,n._path,new fu,!1)),this.database=e,this._delegate=n}getKey(){return M("Reference.key",0,0,arguments.length),this._delegate.key}child(e){return M("Reference.child",1,1,arguments.length),typeof e=="number"&&(e=String(e)),new di(this.database,Jr(this._delegate,e))}getParent(){M("Reference.parent",0,0,arguments.length);const e=this._delegate.parent;return e?new di(this.database,e):null}getRoot(){return M("Reference.root",0,0,arguments.length),new di(this.database,this._delegate.root)}set(e,n){M("Reference.set",1,2,arguments.length),ke("Reference.set","onComplete",n,!0);const r=lp(this._delegate,e);return n&&r.then(()=>n(null),i=>n(i)),r}update(e,n){if(M("Reference.update",1,2,arguments.length),Array.isArray(e)){const i={};for(let s=0;s<e.length;++s)i[""+s]=e[s];e=i,XE("Passing an Array to Firebase.update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")}Tt("Reference.update",this._delegate._path),ke("Reference.update","onComplete",n,!0);const r=Mb(this._delegate,e);return n&&r.then(()=>n(null),i=>n(i)),r}setWithPriority(e,n,r){M("Reference.setWithPriority",2,3,arguments.length),ke("Reference.setWithPriority","onComplete",r,!0);const i=Lb(this._delegate,e,n);return r&&i.then(()=>r(null),s=>r(s)),i}remove(e){M("Reference.remove",0,1,arguments.length),ke("Reference.remove","onComplete",e,!0);const n=Ob(this._delegate);return e&&n.then(()=>e(null),r=>e(r)),n}transaction(e,n,r){M("Reference.transaction",1,3,arguments.length),ke("Reference.transaction","transactionUpdate",e,!1),ke("Reference.transaction","onComplete",n,!0),Cx("Reference.transaction","applyLocally",r,!0);const i=Ex(this._delegate,e,{applyLocally:r}).then(s=>new Nx(s.committed,new er(this.database,s.snapshot)));return n&&i.then(s=>n(null,s.committed,s.snapshot),s=>n(s,!1,null)),i}setPriority(e,n){M("Reference.setPriority",1,2,arguments.length),ke("Reference.setPriority","onComplete",n,!0);const r=Db(this._delegate,e);return n&&r.then(()=>n(null),i=>n(i)),r}push(e,n){M("Reference.push",0,2,arguments.length),ke("Reference.push","onComplete",n,!0);const r=xb(this._delegate,e),i=r.then(o=>new di(this.database,o));n&&i.then(()=>n(null),o=>n(o));const s=new di(this.database,r);return s.then=i.then.bind(i),s.catch=i.catch.bind(i,void 0),s}onDisconnect(){return Tt("Reference.onDisconnect",this._delegate._path),new Rx(new bb(this._delegate._repo,this._delegate._path))}get key(){return this.getKey()}get parent(){return this.getParent()}get root(){return this.getRoot()}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(e,n){this._delegate=e,this.app=n,this.INTERNAL={delete:()=>this._delegate._delete(),forceWebSockets:cx,forceLongPolling:dx}}useEmulator(e,n,r={}){hx(this._delegate,e,n,r)}ref(e){if(M("database.ref",0,1,arguments.length),e instanceof br){const n=Og(this._delegate,e.toString());return new br(this,n)}else{const n=qE(this._delegate,e);return new br(this,n)}}refFromURL(e){M("database.refFromURL",1,1,arguments.length);const r=Og(this._delegate,e);return new br(this,r)}goOffline(){return M("database.goOffline",0,0,arguments.length),fx(this._delegate)}goOnline(){return M("database.goOnline",0,0,arguments.length),px(this._delegate)}}xo.ServerValue={TIMESTAMP:vx(),increment:t=>yx(t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aD="storage-compat";function lD(t,{instanceIdentifier:e}){const n=t.getProvider("app-compat").getImmediate(),r=t.getProvider("storage").getImmediate({identifier:e});return new E0(n,r)}function uD(t){const e={TaskState:$e,TaskEvent:OO,StringFormat:Ct,Storage:E0,Reference:yn};t.INTERNAL.registerComponent(new mt(aD,lD,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),t.registerVersion(sD,oD)}uD(U);const cD={apiKey:"AIzaSyBzKwHZ5Qa4NfxeBUn5-KoymCUI1Z0EyXE",authDomain:"pixpair.firebaseapp.com",databaseURL:"https://pixpair-default-rtdb.firebaseio.com",projectId:"pixpair",storageBucket:"pixpair.appspot.com",messagingSenderId:"743134014753",appId:"1:743134014753:web:da56b2391f4eb69a63a260",measurementId:"G-08ST8X93R2"};U.apps.length||U.initializeApp(cD);const Yg=U.auth(),Rs=U.database(),dD=()=>{if(U.apps.length>0)return U.apps[0];try{return U.app()}catch(t){return console.error("Error initializing Firebase:",t),null}};/**
 ...
 *
 * @license MIT
 */function ih(){return ih=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},ih.apply(this,arguments)}var Jg;(function(t){t.Pop="POP",t.Push="PUSH",t.Replace="REPLACE"})(Jg||(Jg={}));function tr(t,e){if(t===!1||t===null||typeof t>"u")throw new Error(e)}function I0(t){let e={};if(t){let n=t.indexOf("#");n>=0&&(e.hash=t.substr(n),t=t.substr(0,n));let r=t.indexOf("?");r>=0&&(e.search=t.substr(r),t=t.substr(0,r)),t&&(e.pathname=t)}return e}var Xg;(function(t){t.data="data",t.deferred="deferred",t.redirect="redirect",t.error="error"})(Xg||(Xg={}));function hD(t,e){e===void 0&&(e="/");let{pathname:n,search:r="",hash:i=""}=typeof t=="string"?I0(t):t;return{pathname:n?n.startsWith("/")?n:fD(n,e):e,search:vD(r),hash:yD(i)}}function fD(t,e){let n=e.replace(/\/+$/,"").split("/");return t.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function xc(t,e,n,r){return"Cannot include a '"+t+"' character in a manually specified "+("`to."+e+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function pD(t){return t.filter((e,n)=>n===0||e.route.path&&e.route.path.length>0)}function mD(t,e){let n=pD(t);return e?n.map((r,i)=>i===n.length-1?r.pathname:r.pathnameBase):n.map(r=>r.pathnameBase)}function gD(t,e,n,r){r===void 0&&(r=!1);let i;typeof t=="string"?i=I0(t):(i=ih({},t),tr(!i.pathname||!i.pathname.includes("?"),xc("?","pathname","search",i)),tr(!i.pathname||!i.pathname.includes("#"),xc("#","pathname","hash",i)),tr(!i.search||!i.search.includes("#"),xc("#","search","hash",i)));let s=t===""||i.pathname==="",o=s?"/":i.pathname,a;if(o==null)a=n;else{let c=e.length-1;if(!r&&o.startsWith("..")){let h=o.split("/");for(;h[0]==="..";)h.shift(),c-=1;i.pathname=h.join("/")}a=c>=0?e[c]:"/"}let l=hD(i,a),u=o&&o!=="/"&&o.endsWith("/"),d=(s||o===".")&&n.endsWith("/");return!l.pathname.endsWith("/")&&(u||d)&&(l.pathname+="/"),l}const _D=t=>t.join("/").replace(/\/\/+/g,"/"),vD=t=>!t||t==="?"?"":t.startsWith("?")?t:"?"+t,yD=t=>!t||t==="#"?"":t.startsWith("#")?t:"#"+t,S0=["post","put","patch","delete"];new Set(S0);const wD=["get",...S0];new Set(wD);/**
 ...
 *
 * @license MIT
 */function sh(){return sh=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},sh.apply(this,arguments)}const T0=b.createContext(null),C0=b.createContext(null),k0=b.createContext(null),mp=b.createContext({outlet:null,matches:[],isDataRoute:!1});function R0(){return b.useContext(k0)!=null}function ED(){return R0()||tr(!1),b.useContext(k0).location}function N0(t){b.useContext(C0).static||b.useLayoutEffect(t)}function P0(){let{isDataRoute:t}=b.useContext(mp);return t?kD():ID()}function ID(){R0()||tr(!1);let t=b.useContext(T0),{basename:e,future:n,navigator:r}=b.useContext(C0),{matches:i}=b.useContext(mp),{pathname:s}=ED(),o=JSON.stringify(mD(i,n.v7_relativeSplatPath)),a=b.useRef(!1);return N0(()=>{a.current=!0}),b.useCallback(function(u,d){if(d===void 0&&(d={}),!a.current)return;if(typeof u=="number"){r.go(u);return}let c=gD(u,JSON.parse(o),s,d.relative==="path");t==null&&e!=="/"&&(c.pathname=c.pathname==="/"?e:_D([e,c.pathname])),(d.replace?r.replace:r.push)(c,d.state,d)},[e,r,o,s,t])}var A0=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(A0||{}),b0=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(b0||{});function SD(t){let e=b.useContext(T0);return e||tr(!1),e}function TD(t){let e=b.useContext(mp);return e||tr(!1),e}function CD(t){let e=TD(),n=e.matches[e.matches.length-1];return n.route.id||tr(!1),n.route.id}function kD(){let{router:t}=SD(A0.UseNavigateStable),e=CD(b0.UseNavigateStable),n=b.useRef(!1);return N0(()=>{n.current=!0}),b.useCallback(function(i,s){s===void 0&&(s={}),n.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,sh({fromRouteId:e},s)))},[t,e])}new Promise(()=>{});const RD=({onCreateSession:t,onJoinSession:e,onSignOut:n})=>{const[r,i]=b.useState(""),[s,o]=b.useState(""),[a,l]=b.useState(!1),[u,d]=b.useState(null),[c,h]=b.useState(!1),g=P0();b.useEffect(()=>{const p=new URLSearchParams(window.location.search).get("sessionId");p&&_(p)},[]);const _=async f=>{var p;try{if(d(null),h(!0),!(await U.database().ref(`sessions/${f}`).once("value")).val()){d("Session not found. Please check the ID and try again.");return}const C=(p=U.auth().currentUser)==null?void 0:p.uid;if(!C){d("You must be signed in to join a session.");return}await U.database().ref(`sessions/${f}/members/${C}`).set({joinedAt:U.database.ServerValue.TIMESTAMP}),e(f),g("/camera")}catch(v){console.error("Error joining session:",v),d("Failed to join session. Please try again.")}finally{h(!1)}},y=async f=>{f.preventDefault(),d(null),h(!0);try{a?await U.auth().createUserWithEmailAndPassword(r,s):await U.auth().signInWithEmailAndPassword(r,s);const p=Math.random().toString(36).substring(2,8).toUpperCase(),v=U.auth().currentUser.uid;await U.database().ref(`sessions/${p}`).set({createdBy:v,createdAt:U.database.ServerValue.TIMESTAMP,members:{[v]:{joinedAt:U.database.ServerValue.TIMESTAMP}}}),t(p),g("/camera")}catch(p){console.error("Authentication error:",p),d(p.message)}finally{h(!1)}},R=async()=>{d(null),h(!0);try{const f=new U.auth.GoogleAuthProvider;await U.auth().signInWithPopup(f);const p=Math.random().toString(36).substring(2,8).toUpperCase(),v=U.auth().currentUser.uid;await U.database().ref(`sessions/${p}`).set({createdBy:v,createdAt:U.database.ServerValue.TIMESTAMP,members:{[v]:{joinedAt:U.database.ServerValue.TIMESTAMP}}}),t(p),g("/camera")}catch(f){console.error("Google auth error:",f),d(f.message)}finally{h(!1)}},m=async()=>{d(null),h(!0);try{await U.auth().signInAnonymously();const f=Math.random().toString(36).substring(2,8).toUpperCase(),p=U.auth().currentUser.uid;await U.database().ref(`sessions/${f}`).set({createdBy:p,createdAt:U.database.ServerValue.TIMESTAMP,members:{[p]:{joinedAt:U.database.ServerValue.TIMESTAMP}}}),t(f),g("/camera")}catch(f){console.error("Anonymous auth error:",f),d(f.message)}finally{h(!1)}};return S.jsxs("div",{className:"auth-screen",children:[S.jsx("h1",{children:"PixCrab"}),S.jsx("p",{children:"Synchronized Photo Capture"}),u&&S.jsx("div",{className:"error",children:u}),S.jsxs("div",{className:"auth-options",children:[S.jsx("button",{className:"btn btn-google rainbow-button w-full",onClick:R,disabled:c,children:"Continue with Google"}),S.jsx("button",{className:"btn btn-text",onClick:m,disabled:c,children:"Continue as Guest"}),S.jsx("div",{className:"auth-separator",children:S.jsx("span",{children:"or"})})]}),S.jsxs("form",{onSubmit:y,children:[S.jsx("h2",{children:a?"Create Account":"Sign In"}),S.jsxs("div",{className:"form-group",children:[S.jsx("label",{htmlFor:"email",children:"Email"}),S.jsx("input",{type:"email",id:"email",value:r,onChange:f=>i(f.target.value),required:!0})]}),S.jsxs("div",{className:"form-group",children:[S.jsx("label",{htmlFor:"password",children:"Password"}),S.jsx("input",{type:"password",id:"password",value:s,onChange:f=>o(f.target.value),required:!0})]}),S.jsx("button",{type:"submit",className:"auth-form-button",disabled:c,children:a?"Sign Up":"Sign In"})]}),S.jsx("button",{className:"btn btn-secondary",onClick:()=>l(!a),disabled:c,children:a?"Already have an account? Sign In":"Need an account? Sign Up"})]})},ND=({onCreateSession:t,onJoinSession:e,onSignOut:n,initialSessionId:r})=>{const[i,s]=b.useState(""),[o,a]=b.useState(null),[l,u]=b.useState(null),[d,c]=b.useState(""),h=b.useRef(null);b.useEffect(()=>{r&&_(r)},[r]),b.useEffect(()=>{l&&h.current&&y(l)},[l]);const g=async()=>{var m;try{a(null),c("");const f=Math.random().toString(36).substring(2,8).toUpperCase(),p=(m=U.auth().currentUser)==null?void 0:m.uid;if(!p)throw new Error("User not authenticated");await U.database().ref(`sessions/${f}`).set({createdBy:p,createdAt:U.database.ServerValue.TIMESTAMP,members:{[p]:{joinedAt:U.database.ServerValue.TIMESTAMP}}}),u(f),t(f)}catch(f){console.error("Error creating session:",f),a("Failed to create session. Please try again.")}},_=async m=>{var f;try{a(null),c("");const p=m||i;if(!p){a("Please enter a session ID");return}if(!(await U.database().ref(`sessions/${p}`).once("value")).val()){a("Session not found. Please check the ID and try again.");return}const C=(f=U.auth().currentUser)==null?void 0:f.uid;if(!C)throw new Error("User not authenticated");await U.database().ref(`sessions/${p}/members/${C}`).set({joinedAt:U.database.ServerValue.TIMESTAMP}),u(p),e(p)}catch(p){console.error("Error joining session:",p),a("Failed to join session. Please try again.")}},y=m=>{if(h.current){h.current.innerHTML="";const f=`${window.location.origin}${window.location.pathname}?sessionId=${m}`;try{new QRCode(h.current,{text:f,width:256,height:256,colorDark:"#000000",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H})}catch(p){console.error("Error generating QR code:",p),h.current&&(h.current.innerHTML='<p style="color: red;">Failed to generate QR code</p>')}}},R=()=>{l&&navigator.clipboard.writeText(l).then(()=>{c("Copied!"),setTimeout(()=>c(""),2e3)}).catch(m=>{console.error("Failed to copy:",m),c("Failed to copy")})};return S.jsxs("div",{className:"session-setup pt-20",children:[S.jsx("h1",{className:"text-3xl font-bold mt-4",children:"PixCrab"}),S.jsx("p",{className:"text-gray-600 mt-2",children:"Create a new session or join an existing one"}),o&&S.jsx("div",{className:"error",children:o}),S.jsxs("div",{className:"session-actions",children:[S.jsx("button",{className:"btn btn-primary rainbow-button",onClick:g,children:"Create New Session"}),S.jsxs("div",{className:"session-join",children:[S.jsx("input",{type:"text",placeholder:"Enter Session ID",value:i,onChange:m=>s(m.target.value)}),S.jsx("button",{className:"btn btn-secondary",onClick:()=>_(),children:"Join Session"})]})]}),l&&S.jsxs("div",{className:"session-info",children:[S.jsxs("div",{className:"session-id-container",children:[S.jsx("span",{className:"session-id-label",children:"Session ID:"}),S.jsx("span",{className:"session-id",children:l}),S.jsx("button",{className:"btn btn-icon",onClick:R,title:"Copy Session ID",children:"Copy"}),d&&S.jsx("span",{className:"copy-status",children:d})]}),S.jsx("p",{children:"Scan this QR code to join the session:"}),S.jsx("div",{className:"qr-code-container",ref:h})]}),S.jsx("button",{className:"btn btn-text",onClick:n,children:"Sign Out"})]})},PD=()=>S.jsx("div",{className:"logo-container",children:S.jsx("img",{src:"https://firebasestorage.googleapis.com/v0/b/pixpair.firebasestorage.app/o/crab5.svg?alt=media&token=93592dde-03d2-4140-bf36-c4cb0ca39f85",alt:"PixCrab logo",className:"logo-image"})}),AD=({sessionId:t,onExitSession:e,onSignOut:n})=>{const[r,i]=b.useState(null),[s,o]=b.useState(!1),[a,l]=b.useState([]),[u,d]=b.useState(!1),[c,h]=b.useState(null),[g,_]=b.useState({}),[y,R]=b.useState(0),[m,f]=b.useState(""),p=b.useRef(null),v=b.useRef(null),T=b.useRef(null),C=P0();b.useEffect(()=>{if(!t){console.log("No session ID provided, redirecting to home"),C("/");return}},[t,C]),b.useEffect(()=>{var Y;function F(){const k=window.visualViewport?window.visualViewport.height:window.innerHeight;document.documentElement.style.setProperty("--viewport-height",`${k}px`),console.log("📏 Updated viewport height:",k)}return F(),(Y=window.visualViewport)==null||Y.addEventListener("resize",F),window.addEventListener("resize",F),()=>{var k;(k=window.visualViewport)==null||k.removeEventListener("resize",F),window.removeEventListener("resize",F)}},[]),b.useEffect(()=>{var F;console.log("🔍 BUTTON RENDER CONDITIONS:",{cameraReady:s,uploading:u,countdown:c,participantCount:y,disabled:!s||u||c!==null||y<2,videoRef:v.current?"exists":"null",videoSrcObject:(F=v.current)!=null&&F.srcObject?"stream active":"no stream"})},[s,u,c,y]);const N=async()=>{console.log("🎥 STARTING CAMERA INITIALIZATION");try{const F=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"},audio:!1});console.log("🎥 CAMERA STREAM OBTAINED:",F?"success":"failed"),v.current?(v.current.srcObject=F,console.log("🎥 ASSIGNED STREAM TO VIDEO ELEMENT"),v.current.onloadedmetadata=()=>{console.log("🎥 VIDEO METADATA LOADED, SETTING CAMERA READY"),o(!0)}):console.error("🎥 VIDEO REF IS NULL")}catch(F){console.error("🎥 ERROR ACCESSING CAMERA:",F),i("Could not access camera. Please check permissions.")}};b.useEffect(()=>{console.log("🎥 CAMERA READY STATE CHANGED:",s)},[s]),b.useEffect(()=>{if(!t)return;console.log("Initializing camera and Firebase listeners for session:",t),N();const F=Rs.ref(`sessions/${t}/photos`);F.on("child_added",O=>{const D={id:O.key,...O.val()};l(ie=>[...ie,D])});const Y=Rs.ref(`sessions/${t}/members`);Y.on("value",O=>{const D=O.val()||{};_(D),R(Object.keys(D).length)});const k=Rs.ref(`sessions/${t}/capture`);return k.on("value",O=>{const D=O.val();D&&D.captureTime&&vr(D.captureTime)}),()=>{A(),F.off(),Y.off(),k.off(),clearInterval(p.current)}},[t]);const A=()=>{v.current&&v.current.srcObject&&(v.current.srcObject.getTracks().forEach(Y=>Y.stop()),v.current.srcObject=null,o(!1))},G=()=>{A(),e()},j=()=>{t&&navigator.clipboard.writeText(t).then(()=>{f("Copied!"),setTimeout(()=>f(""),2e3)}).catch(F=>{console.error("Failed to copy:",F),f("Failed to copy")})},at=async()=>{var F;try{const Y=Date.now()+3e3;await Rs.ref(`sessions/${t}/capture`).set({captureTime:Y,initiatedBy:((F=U.auth().currentUser)==null?void 0:F.uid)||"anonymous",initiated:U.database.ServerValue.TIMESTAMP}),console.log(`Initiated capture for time: ${new Date(Y).toISOString()}`)}catch(Y){console.error("Error initiating capture:",Y),i("Failed to initiate synchronized capture.")}},vr=F=>{p.current&&clearInterval(p.current);const Y=Date.now(),k=F-Y;if(k<=0){console.log("Capture time already passed");return}console.log(`Starting countdown for capture at ${new Date(F).toISOString()}`);const O=Math.ceil(k/1e3);h(O),p.current=setInterval(()=>{h(D=>D<=1?(clearInterval(p.current),yr(),null):D-1)},1e3),setTimeout(()=>{p.current&&(clearInterval(p.current),h(null))},k+100)},yr=async()=>{if(!(!s||u))try{d(!0),i(null);const F=v.current,Y=T.current;Y.width=F.videoWidth,Y.height=F.videoHeight,Y.getContext("2d").drawImage(F,0,0);const O=Y.toDataURL("image/jpeg",.8),D=U.auth().currentUser?U.auth().currentUser.uid:"anonymous",ie=Date.now();await Rs.ref(`sessions/${t}/photos/${U.auth().currentUser.uid}`).set({dataUrl:Y.toDataURL("image/jpeg",.8),timestamp:U.database.ServerValue.TIMESTAMP}),console.log("Photo saved successfully")}catch(F){console.error("Error taking photo:",F),i("Failed to take photo. Please try again.")}finally{d(!1)}},ea=F=>{const Y=F.dataUrl||F.downloadURL;return Y?S.jsxs("div",{className:"photo-item",children:[S.jsx("img",{src:Y,alt:"Captured"}),S.jsxs("p",{children:["Taken at: ",new Date(F.timestamp).toLocaleTimeString()]})]},F.id):S.jsx("div",{className:"photo-item error",children:S.jsx("p",{children:"Photo unavailable"})},F.id)},Lu=()=>{C("/album")};return S.jsxs("div",{className:"camera-screen",children:[S.jsxs("div",{className:"camera-container",children:[S.jsx("video",{ref:v,autoPlay:!0,playsInline:!0,muted:!0,className:"h-full w-auto object-cover mx-auto"}),S.jsx("canvas",{ref:T,style:{display:"none"}}),c!==null&&S.jsx("div",{className:"countdown-overlay",children:S.jsx("div",{className:"countdown-number",children:c})})]}),S.jsxs("div",{className:"camera-screen-content",children:[S.jsxs("div",{className:"header-area",children:[S.jsxs("div",{className:"participants-count",children:["Participants: ",y,"/2"]}),r&&S.jsx("div",{className:"error",children:r}),S.jsxs("div",{className:"session-header",children:[S.jsx("button",{className:"btn btn-primary rainbow-button",onClick:Lu,title:"View Gallery",children:"Gallery"}),S.jsx("button",{className:"btn-icon exit-btn",onClick:G,title:"Exit Session",children:S.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[S.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),S.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]})}),S.jsxs("button",{className:"session-id-btn",onClick:j,title:"Copy Session ID",children:[t,S.jsxs("svg",{className:"copy-icon",xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[S.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),S.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]}),m&&S.jsx("span",{className:"copy-status",children:m})]})]})]}),S.jsx("div",{className:"viewfinder-area"}),S.jsx("div",{className:"controls-area",children:S.jsx("div",{className:"shutter-button-container",children:s&&S.jsx("button",{className:`
                  btn-circle btn-circle-rainbow
                  w-16 h-16 bg-white shadow-lg
                  border-4 border-gray-200 z-50
                  disabled:opacity-50 disabled:cursor-not-allowed
                `,onClick:at,disabled:!s||u||c!==null||y<2,children:S.jsx("span",{className:"block w-8 h-8 bg-gray-200 rounded-full m-auto"})})})})]}),S.jsx("div",{className:"photos-grid",children:a.map(ea)})]})},bD=b.createContext(null),xD=({children:t,value:e})=>S.jsx(bD.Provider,{value:e,children:t});dD();function OD(){const[t,e]=b.useState("auth"),[n,r]=b.useState(null),[i,s]=b.useState(null),[o,a]=b.useState(!1),[l,u]=b.useState(null);b.useEffect(()=>{if(!window.firebaseConfig){u("Firebase configuration not found. Please check your setup.");return}try{a(!0)}catch(_){console.error("Error initializing app:",_),u("Failed to initialize the application. Please try again later.")}},[]),b.useEffect(()=>{if(!o)return;const _=Yg.onAuthStateChanged(m=>{r(m),e(m?"session":"auth")}),R=new URLSearchParams(window.location.search).get("sessionId");return R&&s(R),()=>_()},[o]);const d=_=>{s(_),e("camera")},c=_=>{s(_),e("camera")},h=()=>{s(null),e("session")},g=async()=>{try{await Yg.signOut(),e("auth"),s(null)}catch(_){console.error("Error signing out:",_)}};return l?S.jsx("div",{className:"app-container",children:S.jsx("div",{className:"error",children:l})}):o?S.jsx(xD,{value:{user:n,sessionId:i},children:S.jsxs("div",{className:`app-container ${t==="camera"?"camera-mode":""}`,children:[t!=="camera"&&S.jsx("div",{className:"flex justify-center items-center w-full mb-4",children:S.jsx(PD,{})}),t==="auth"&&S.jsx(RD,{}),t==="session"&&S.jsx(ND,{onCreateSession:d,onJoinSession:c,onSignOut:g,initialSessionId:i}),t==="camera"&&S.jsx(AD,{sessionId:i,onExitSession:h,onSignOut:g})]})}):S.jsx("div",{className:"app-container",children:S.jsx("div",{children:"Loading..."})})}Oc.createRoot(document.getElementById("root")).render(S.jsx(K0.StrictMode,{children:S.jsx(OD,{})}));
//# sourceMappingURL=main-38d44cc3.js.map
