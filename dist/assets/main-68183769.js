 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(k,b){var U=k.length;k.push(b);e:for(;0<U;){var de=U-1>>>1,Se=k[de];if(0<i(Se,b))k[de]=b,k[U]=Se,U=de;else break e}}function n(k){return k.length===0?null:k[0]}function r(k){if(k.length===0)return null;var b=k[0],U=k.pop();if(U!==b){k[0]=U;e:for(var de=0,Se=k.length,ta=Se>>>1;de<ta;){var wr=2*(de+1)-1,Lu=k[wr],Er=wr+1,na=k[Er];if(0>i(Lu,U))Er<Se&&0>i(na,Lu)?(k[de]=na,k[Er]=U,de=Er):(k[de]=Lu,k[wr]=U,de=wr);else if(Er<Se&&0>i(na,U))k[de]=na,k[Er]=U,de=Er;else break e}}return b}function i(k,b){var U=k.sortIndex-b.sortIndex;return U!==0?U:k.id-b.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,c=null,h=3,g=!1,_=!1,y=!1,C=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(k){for(var b=n(u);b!==null;){if(b.callback===null)r(u);else if(b.startTime<=k)r(u),b.sortIndex=b.expirationTime,e(l,b);else break;b=n(u)}}function v(k){if(y=!1,p(k),!_)if(n(l)!==null)_=!0,q(T);else{var b=n(u);b!==null&&be(v,b.startTime-k)}}function T(k,b){_=!1,y&&(y=!1,m(A),A=-1),g=!0;var U=h;try{for(p(b),c=n(l);c!==null&&(!(c.expirationTime>b)||k&&!lt());){var de=c.callback;if(typeof de=="function"){c.callback=null,h=c.priorityLevel;var Se=de(c.expirationTime<=b);b=t.unstable_now(),typeof Se=="function"?c.callback=Se:c===n(l)&&r(l),p(b)}else r(l);c=n(l)}if(c!==null)var ta=!0;else{var wr=n(u);wr!==null&&be(v,wr.startTime-b),ta=!1}return ta}finally{c=null,h=U,g=!1}}var N=!1,R=null,A=-1,G=5,z=-1;function lt(){return!(t.unstable_now()-z<G)}function vr(){if(R!==null){var k=t.unstable_now();z=k;var b=!0;try{b=R(!0,k)}finally{b?yr():(N=!1,R=null)}}else N=!1}var yr;if(typeof f=="function")yr=function(){f(vr)};else if(typeof MessageChannel<"u"){var ea=new MessageChannel,F=ea.port2;ea.port1.onmessage=vr,yr=function(){F.postMessage(null)}}else yr=function(){C(vr,0)};function q(k){R=k,N||(N=!0,yr())}function be(k,b){A=C(function(){k(t.unstable_now())},b)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(k){k.callback=null},t.unstable_continueExecution=function(){_||g||(_=!0,q(T))},t.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<k?Math.floor(1e3/k):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(k){switch(h){case 1:case 2:case 3:var b=3;break;default:b=h}var U=h;h=b;try{return k()}finally{h=U}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(k,b){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var U=h;h=k;try{return b()}finally{h=U}},t.unstable_scheduleCallback=function(k,b,U){var de=t.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?de+U:de):U=de,k){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=U+Se,k={id:d++,callback:b,priorityLevel:k,startTime:U,expirationTime:Se,sortIndex:-1},U>de?(k.sortIndex=U,e(u,k),n(l)===null&&k===n(u)&&(y?(m(A),A=-1):y=!0,be(v,U-de))):(k.sortIndex=Se,e(l,k),_||g||(_=!0,q(T))),k},t.unstable_shouldYield=lt,t.unstable_wrapCallback=function(k){var b=h;return function(){var U=h;h=b;try{return k.apply(this,arguments)}finally{h=U}}}})(s_);i_.exports=s_;var F0=i_.exports;/**
 * @license React
